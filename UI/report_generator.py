...
class ReportGenerator:
    ...
    def _filter_nodes(
        self, nodes: List[Dict[str, Any]], selected_node_ids: List[str] | None
    ) -> List[Dict[str, Any]]:
    ...
    def _create_nodes_table(self, nodes: List[Dict[str, Any]]) -> Table:
        ...
        for node in nodes:
            ...
            data.append([node.get("label", "N/A")[:40], translated_type])
    ...
    def _create_stats_table(
        ...
        data = [
            ...
            [
                "Типы узлов",
                ", ".join(
                    [NODE_TYPE_TRANSLATIONS.get(t, t) for t in node_types.keys()]
                ),
            ],
            [
                "Типы связей",
                ", ".join(
                    [EDGE_TYPE_TRANSLATIONS.get(t, t) for t in edge_types.keys()]
                ),
            ],
        ]
